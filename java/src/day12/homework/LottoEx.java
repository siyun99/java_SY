...
public class LottoEx {
	...
	public static void main(String[] args) {
		...
		printResult(count, Array.contains(user, bouns, user.length));
		sc.close();
	}
	...
	/**일치하는 개수와 보너스번호와 사용자 번호가 일치하는지 여부를 알려주면
	 * 등수를 출력하는 메서드
	 * 매개변수: 일치하는 개수, 보너스번호와 일치 여부
	 * 			=>int count, boolean checkBouns
	 * 리턴타입: 없음 => void
	 * 메서드명: printResult
	 */
	public static void printResult(int count, boolean checkBouns) {
		switch(count) {
		case 6:
