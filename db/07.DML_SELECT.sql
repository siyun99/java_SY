...
=> 속성명 >= A and 속성명 <= B
속성명 in(값1, 값2, ..., 값n) : 속성의 값이 값1이거나 값2 이거나 ... 값n인 조건을 만족할 떄 사용
=> 속성명 = 값1 or 속성명 = 값2 or ... or 속성명 = 값n
*/
/*
distinct : 행이 중복된 결과를 제거하고 조회 
...
-- 학생들 정보를 학번순으로 오름차순으로 정렬 후, 2명씩 보여줄 때 3번째 페이지에 있는 학생 정보를 조회하는 쿼리
select * from student limit 4,2;


-- 밑에 줄을 해줘야 밑에 코드가 실행됨
